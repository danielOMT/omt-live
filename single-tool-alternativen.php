    ...
    <div id="inner-content" class="wrap clearfix">
        ...
        if (1 == $rueckruf_button) {
            ...
            if (1 == $buttons_anzeigen) { ?>
                ...
                align-content: flex-start;
            ">
                    <?php if (strlen($tool_gratis_testen_link) > 0) { ?><a style="width:225px;margin-right:0px !important;margin-bottom:10px !important;" rel="nofollow" id="<?php print get_the_title();?>"  target="_blank" class="button button-testen button-red button-350px"  href="<?php print $tool_gratis_testen_link;?>">Gratis testen</a><?php } ?>
                    <?php if (strlen($tool_preisubersicht) > 0) { ?><a style="width:225px;" rel="nofollow" id="<?php print get_the_title();?>" target="_blank" class="button button-pricing button-lightgrey button-350px"  href="<?php print $tool_preisubersicht;?>">Preisübersicht</a><?php } ?>
                </div>
            <?php }
        } ?>
    </div>
