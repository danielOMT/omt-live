<?php
add_submenu_page( 'themenwelten', 'Google My Business', 'Google My Business',
    'read', 'edit.php?post_type=gmb');
function google_my_business() {
    register_post_type('gmb', array(
        'labels' => array(
            'name' => __('Google My Business', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Google My Business', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'google-my-business', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'google_my_business');
