<?php
add_submenu_page( 'themenwelten', 'Local SEO', 'Local SEO',
    'read', 'edit.php?post_type=local');
function local_seo() {
    register_post_type('local', array(
        'labels' => array(
            'name' => __('Local SEO', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Local SEO', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'local-seo', 'with_front' => false ), /* you can specify its url slug */
