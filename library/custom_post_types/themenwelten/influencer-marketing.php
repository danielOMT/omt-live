<?php
add_submenu_page( 'themenwelten', 'Influencer Marketing', 'Influencer Marketing',
    'read', 'edit.php?post_type=influencer');
function influencer_marketing() {
    register_post_type('influencer', array(
        'labels' => array(
            'name' => __('Influencer Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Influencer Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'influencer-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'influencer_marketing');
