<?php
add_submenu_page( 'themenwelten', 'E-Commerce', 'E-Commerce',
    'read', 'edit.php?post_type=e-commerce');
function e_commerce() {
    register_post_type('e-commerce', array(
        'labels' => array(
            'name' => __('E-Commerce', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt E-Commerce', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'e-commerce', 'with_front' => false ), /* you can specify its url slug */
