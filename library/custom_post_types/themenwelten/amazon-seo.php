<?php
add_submenu_page( 'themenwelten', 'Amazon SEO', 'Amazon SEO',
    'read', 'edit.php?post_type=amazon');
function amazon_seo() {
    register_post_type('amazon', array(
        'labels' => array(
            'name' => __('Amazon SEO', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Amazon SEO', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'amazon-seo', 'with_front' => false ), /* you can specify its url slug */
