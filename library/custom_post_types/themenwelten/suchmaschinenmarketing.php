<?php
add_submenu_page( 'themenwelten', 'Suchmaschinenmarketing', 'Suchmaschinenmarketing',
    'read', 'edit.php?post_type=sma');
function suchmaschinenmarketing() {
    register_post_type('sma', array(
        'labels' => array(
            'name' => __('Suchmaschinenmarketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Suchmaschinenmarketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'suchmaschinenmarketing', 'with_front' => false ), /* you can specify its url slug */
        'has_archive' => false, //'suchmaschinenmarketing', /* you can rename the slug here */
    ...
    // register_taxonomy_for_object_type('category', 'suchmaschinenmarketing');
    //  register_taxonomy_for_object_type('post_tag', 'suchmaschinenmarketing');
}
add_action( 'init', 'suchmaschinenmarketing');
