<?php
add_submenu_page( 'themenwelten', 'Growth Hacking', 'Growth Hacking',
    'read', 'edit.php?post_type=growthhack');
function growth_hacking() {
    register_post_type('growthhack', array(
        'labels' => array(
            'name' => __('Growth Hacking', 'bonestheme'), /* This is the Title of the Group */
            ...
            'parent_item_colon' => 'growthhack'
        ), /* end of arrays */
        'description' => __('Alle Artikel zur Themenwelt Growth Hacking', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'growth-hacking', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'growth_hacking');
