<?php
add_submenu_page( 'themenwelten', 'Pinterest Marketing', 'Pinterest Marketing',
    'read', 'edit.php?post_type=pinterest');
function pinterest_marketing() {
    register_post_type('pinterest', array(
        'labels' => array(
            'name' => __('Pinterest Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Pinterest Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'pinterest-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'pinterest_marketing');
