<?php
add_submenu_page( 'themenwelten', 'Wordpress Pagespeed', 'Wordpress Pagespeed',
    'read', 'edit.php?post_type=pagespeed');
function pagespeed() {
    register_post_type('pagespeed', array(
        'labels' => array(
            'name' => __('Wordpress Pagespeed', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Wordpress Pagespeed', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'wordpress-pagespeed', 'with_front' => false ), /* you can specify its url slug */
        'has_archive' => false, //'wordpress-pagespeed', /* you can rename the slug here */
    ...
    // register_taxonomy_for_object_type('category', 'wordpress-pagespeed');
    //  register_taxonomy_for_object_type('post_tag', 'wordpress-pagespeed');
}
add_action( 'init', 'pagespeed');
