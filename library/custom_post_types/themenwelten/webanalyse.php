<?php
add_submenu_page( 'themenwelten', 'Webanalyse', 'Webanalyse',
    'read', 'edit.php?post_type=webanalyse');
function webanalyse() {
    register_post_type('webanalyse', array(
        'labels' => array(
            'name' => __('Webanalyse', 'bonestheme'), /* This is the Title of the Group */
            ...
            'parent_item_colon' => 'webanalyse'
        ), /* end of arrays */
        'description' => __('Alle Artikel zur Themenwelt Webanalyse', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'webanalyse', 'with_front' => false ), /* you can specify its url slug */
