<?php
add_submenu_page( 'themenwelten', 'Google Ads', 'Google Ads',
    'read', 'edit.php?post_type=sea');
function adwords_sea() {
    register_post_type('sea', array(
        'labels' => array(
            'name' => __('Google Ads / SEA', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Google Ads', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'google-ads', 'with_front' => false ), /* you can specify its url slug */
