<?php
add_submenu_page( 'themenwelten', 'Suchmaschinenoptimierung', 'Suchmaschinenoptimierung',
    'read', 'edit.php?post_type=seo');
function suchmaschinenoptimierung() {
    register_post_type('seo', array(
        'labels' => array(
            'name' => __('Suchmaschinenoptimierung', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Suchmaschinenoptimierung', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'suchmaschinenoptimierung', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'suchmaschinenoptimierung');
