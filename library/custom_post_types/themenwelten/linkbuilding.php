<?php
add_submenu_page( 'themenwelten', 'Linkbuilding', 'Linkbuilding',
    'read', 'edit.php?post_type=links');
function linkbuilding() {
    register_post_type('links', array(
        'labels' => array(
            'name' => __('Linkbuilding', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Linkbuilding', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'linkbuilding', 'with_front' => false ), /* you can specify its url slug */
