<?php
add_submenu_page( 'themenwelten', 'Facebook Ads', 'Facebook Ads',
    'read', 'edit.php?post_type=facebook');
function facebook_ads() {
    register_post_type('facebook', array(
        'labels' => array(
            'name' => __('Facebook Ads', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Facebook Ads', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'facebook-ads', 'with_front' => false ), /* you can specify its url slug */
