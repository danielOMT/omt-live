<?php
add_submenu_page( 'themenwelten', 'Google Analytics', 'Google Analytics',
    'read', 'edit.php?post_type=ga');
function google_analytics() {
    register_post_type('ga', array(
        'labels' => array(
            'name' => __('Google Analytics', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Google Analytics', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'google-analytics', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'google_analytics');
