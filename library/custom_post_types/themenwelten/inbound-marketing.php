<?php
add_submenu_page( 'themenwelten', 'Inbound Marketing', 'Inbound Marketing',
    'read', 'edit.php?post_type=inbound');
function inbound_marketing() {
    register_post_type('inbound', array(
        'labels' => array(
            'name' => __('Inbound Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Inbound Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'inbound-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'inbound_marketing');
