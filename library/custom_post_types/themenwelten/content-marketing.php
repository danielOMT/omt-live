<?php
add_submenu_page( 'themenwelten', 'Content Marketing', 'Content Marketing',
    'read', 'edit.php?post_type=content');
function content_marketing() {
    register_post_type('content', array(
        'labels' => array(
            'name' => __('Content Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Content Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'content-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'content_marketing');
