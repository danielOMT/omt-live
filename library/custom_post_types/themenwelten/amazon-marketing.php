<?php
add_submenu_page( 'themenwelten', 'Amazon Marketing', 'Amazon Marketing',
    'read', 'edit.php?post_type=amazon_marketing');
function amazon_marketing() {
    register_post_type('amazon_marketing', array(
        'labels' => array(
            'name' => __('Amazon Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Amazon Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'amazon-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'amazon_marketing');
