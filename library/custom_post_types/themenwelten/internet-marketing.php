<?php
add_submenu_page( 'themenwelten', 'Internet Marketing', 'Internet Marketing',
    'read', 'edit.php?post_type=internetmarketing');
function internet_marketing() {
    register_post_type('internetmarketing', array(
        'labels' => array(
            'name' => __('Internet Marketing', 'bonestheme'), /* This is the Title of the Group */
            ...
            'parent_item_colon' => 'internet-marketing'
        ), /* end of arrays */
        'description' => __('Alle Artikel zur Themenwelt Internet Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true, 
        ...
        'rewrite'	=> array( 'slug' => 'internet-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'internet_marketing');
