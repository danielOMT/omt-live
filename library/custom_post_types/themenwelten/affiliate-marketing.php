<?php
add_submenu_page( 'themenwelten', 'Affiliate Marketing', 'Affiliate Marketing',
    'read', 'edit.php?post_type=affiliate');
function affiliate_marketing() {
    register_post_type('affiliate', array(
        'labels' => array(
            'name' => __('Affiliate Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Affiliate Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'affiliate-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'affiliate_marketing');
