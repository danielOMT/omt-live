<?php
add_submenu_page( 'themenwelten', 'WordPress', 'WordPress',
    'read', 'edit.php?post_type=wordpress');
function wordpress() {
    register_post_type('wordpress', array(
        'labels' => array(
            'name' => __('WordPress', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt WordPress', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'wordpress', 'with_front' => false ), /* you can specify its url slug */
        'has_archive' => false, //'wordpress', /* you can rename the slug here */
    ...
    // register_taxonomy_for_object_type('category', 'wordpress');
    //  register_taxonomy_for_object_type('post_tag', 'wordpress');
}
add_action( 'init', 'wordpress');
