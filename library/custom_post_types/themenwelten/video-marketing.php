<?php
add_submenu_page( 'themenwelten', 'Videomarketing', 'Videomarketing',
    'read', 'edit.php?post_type=videomarketing');
function videomarketing() {
    register_post_type('videomarketing', array(
        'labels' => array(
            'name' => __('Videomarketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Videomarketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'video-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'videomarketing');
