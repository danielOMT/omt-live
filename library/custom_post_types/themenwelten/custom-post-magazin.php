<?php //magazin
add_submenu_page( 'themenwelten', 'Magazin - Unkategorisiert', 'Magazin - Unkategorisiert',
    'read', 'edit.php?post_type=magazin');
function magazin() {
    register_post_type('magazin', array(
        'labels' => array(
            'name' => __('Magazin', 'bonestheme'), /* This is the Title of the Group */
            ...
            'add_new_item' => __('Neuer Artikel hinzufügen', 'bonestheme'), /* Add New Display Title */
        ...
        'description' => __('Magazin-Artikel, welche keiner Themenwelt zugeordnet werden können', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'magazin', 'with_front' => false ), /* you can specify its url slug */
