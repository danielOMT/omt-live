<?php
add_submenu_page( 'themenwelten', 'Online Marketing', 'Online Marketing',
    'read', 'edit.php?post_type=onlinemarketing');
function online_marketing() {
    register_post_type('onlinemarketing', array(
        'labels' => array(
            'name' => __('Online Marketing', 'bonestheme'), /* This is the Title of the Group */
            ...
            'parent_item_colon' => 'online-marketing'
        ), /* end of arrays */
        'description' => __('Alle Artikel zur Themenwelt Online Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true, 
        ...
        'rewrite'	=> array( 'slug' => 'online-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'online_marketing');
