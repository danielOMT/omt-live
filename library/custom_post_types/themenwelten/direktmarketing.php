<?php
add_submenu_page( 'themenwelten', 'Direktmarketing', 'Direktmarketing',
    'read', 'edit.php?post_type=direktmarketing');
function direktmarketing() {
    register_post_type('direktmarketing', array(
        'labels' => array(
            'name' => __('Direktmarketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Direktmarketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'direktmarketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'direktmarketing');
