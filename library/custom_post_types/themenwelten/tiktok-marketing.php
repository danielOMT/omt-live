<?php
add_submenu_page( 'themenwelten', 'TikTok-Marketing', 'TikTok-Marketing',
    'read', 'edit.php?post_type=tiktok');
function tiktok() {
    register_post_type('tiktok', array(
        'labels' => array(
            'name' => __('TikTok-Marketing', 'bonestheme'), /* This is the Title of the Group */
            ...
            'parent_item_colon' => 'tiktok'
        ), /* end of arrays */
        'description' => __('Alle Artikel zur Themenwelt TikTok-Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'tiktok-marketing', 'with_front' => false ), /* you can specify its url slug */
