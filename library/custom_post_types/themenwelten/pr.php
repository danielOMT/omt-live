<?php
add_submenu_page( 'themenwelten', 'PR', 'PR',
    'read', 'edit.php?post_type=p_r');
function pr() {
    register_post_type('p_r', array(
        'labels' => array(
            'name' => __('PR', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt PR', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'pr', 'with_front' => false ), /* you can specify its url slug */
