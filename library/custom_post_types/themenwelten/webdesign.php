<?php
add_submenu_page( 'themenwelten', 'Webdesign', 'Webdesign',
    'read', 'edit.php?post_type=webdesign');
function webdesign() {
    register_post_type('webdesign', array(
        'labels' => array(
            'name' => __('Webdesign', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Webdesign', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'webdesign', 'with_front' => false ), /* you can specify its url slug */
        'has_archive' => false, //'webdesign', /* you can rename the slug here */
    ...
    // register_taxonomy_for_object_type('category', 'webdesign');
    //  register_taxonomy_for_object_type('post_tag', 'webdesign');
}
add_action( 'init', 'webdesign');
