<?php
add_submenu_page( 'themenwelten', 'Conversion Optimierung', 'Conversion Optimierung',
    'read', 'edit.php?post_type=conversion');
function conversion_optimierung() {
    register_post_type('conversion', array(
        'labels' => array(
            'name' => __('Conversion Optimierung', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Conversion Optimierung', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'conversion-optimierung', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'conversion_optimierung');
