<?php
add_submenu_page( 'themenwelten', 'Social Media Marketing', 'Social Media Marketing',
    'read', 'edit.php?post_type=social');
function social_media_marketing() {
    register_post_type('social', array(
        'labels' => array(
            'name' => __('Social Media Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Social Media Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'social-media-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'social_media_marketing');
