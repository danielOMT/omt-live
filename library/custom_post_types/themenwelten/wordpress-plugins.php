<?php
add_submenu_page( 'themenwelten', 'Wordpress Plugins', 'Wordpress Plugins',
    'read', 'edit.php?post_type=plugins');
function plugins() {
    register_post_type('plugins', array(
        'labels' => array(
            'name' => __('Wordpress Plugins', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Wordpress Plugins', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'wordpress-plugins', 'with_front' => false ), /* you can specify its url slug */
