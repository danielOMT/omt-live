<?php
add_submenu_page( 'themenwelten', 'Email Marketing', 'Email Marketing',
    'read', 'edit.php?post_type=emailmarketing');
function emailmarketing() {
    register_post_type('emailmarketing', array(
        'labels' => array(
            'name' => __('Email Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Email Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'e-mail-marketing', 'with_front' => false ), /* you can specify its url slug */
        'has_archive' => false, //'wordpress-plugins', /* you can rename the slug here */
    ...
    // register_taxonomy_for_object_type('category', 'wordpress-plugins');
    //  register_taxonomy_for_object_type('post_tag', 'wordpress-plugins');
}
add_action( 'init', 'emailmarketing');
