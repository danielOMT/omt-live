<?php
add_submenu_page( 'themenwelten', 'Performance Marketing', 'Performance Marketing',
    'read', 'edit.php?post_type=performance');
function performance_marketing() {
    register_post_type('performance', array(
        'labels' => array(
            'name' => __('Performance Marketing', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Performance Marketing', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'performance-marketing', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'performance_marketing');
