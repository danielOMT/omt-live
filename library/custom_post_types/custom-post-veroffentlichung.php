...
add_action( 'admin_menu', 'veroffentlichung_admin_menu' );


function omt_veroffentlichung() {
    register_post_type('veroffentlichung', array(
        'labels' => array(
            'name' => __('Studentenarbeit', 'bonestheme'), /* This is the Title of the Group */
            ...
            'not_found_in_trash' => __('Keine Studentenarbeit im Papierkorb', 'bonestheme'), /* This displays if there is nothing in the trash */
            'parent_item_colon' => ''
        ), /* end of arrays */
        'description' => __('Profil aller Studentenarbeiten', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'studentenarbeiten', 'with_front' => false ), /* you can specify its url slug */
        'has_archive' => false,// 'veroffentlichung', /* you can rename the slug here */
   ...
   // register_taxonomy_for_object_type('category', 'veroffentlichung');
  //  register_taxonomy_for_object_type('post_tag', 'veroffentlichung');
}
add_action( 'init', 'omt_veroffentlichung');
