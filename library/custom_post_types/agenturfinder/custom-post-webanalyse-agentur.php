<?php
add_submenu_page( 'agenturfinder', 'Webanalyse-Agenturen', 'Webanalyse-Agenturen',
'read', 'edit.php?post_type=webanalyseagentur');
function webanalyseagentur() {
register_post_type('webanalyseagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/webanalyse-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'webanalyseagentur');
