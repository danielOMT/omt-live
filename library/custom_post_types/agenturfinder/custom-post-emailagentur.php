<?php
add_submenu_page( 'agenturfinder', 'E-Mail-Agenturen', 'E-Mail-Agenturen',
'read', 'edit.php?post_type=emailagentur');
function emailagentur() {
register_post_type('emailagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/emailagentur', 'with_front' => false ), /* you can specify its url slug */
