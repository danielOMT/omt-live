<?php
add_submenu_page( 'agenturfinder', 'Digitalagenturen', 'Digitalagenturen',
'read', 'edit.php?post_type=digitalagentur');
function digitalagentur() {
register_post_type('digitalagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/digitalagentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'digitalagentur');
