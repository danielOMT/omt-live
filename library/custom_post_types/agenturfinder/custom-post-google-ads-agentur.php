<?php
add_submenu_page( 'agenturfinder', 'Google Ads Agenturen', 'Google Ads Agenturen',
'read', 'edit.php?post_type=gaagentur');
function gaagentur() {
register_post_type('gaagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/google-ads-agentur', 'with_front' => false ), /* you can specify its url slug */
