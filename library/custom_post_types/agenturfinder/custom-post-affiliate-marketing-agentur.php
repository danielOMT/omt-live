<?php
add_submenu_page( 'agenturfinder', 'Affiliate-Marketing-Agenturen', 'Affiliate-Marketing-Agenturen',
'read', 'edit.php?post_type=affiliateagentur');
function affiliateagentur() {
register_post_type('affiliateagentur', array(
'labels' => array(
'name' => __('Artikel', 'bonestheme'), /* This is the Title of the Group */
...
'add_new_item' => __('Neuer Artikel', 'bonestheme'), /* Add New Display Title */
...
'description' => __('Alle Artikel im Agenturfinder', 'bonestheme'), /* Custom Type Description */
'public' => true,
...
'rewrite'	=> array( 'slug' => 'agentur-finden/affiliate-marketing-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'affiliateagentur');
