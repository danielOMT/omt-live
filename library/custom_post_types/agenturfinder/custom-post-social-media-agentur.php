<?php
add_submenu_page( 'agenturfinder', 'Social Media Agenturen', 'Social Media Agenturen',
'read', 'edit.php?post_type=smagentur');
function smagentur() {
register_post_type('smagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/social-media-agentur', 'with_front' => false ), /* you can specify its url slug */
