<?php
add_submenu_page( 'agenturfinder', 'Web-Agenturen', 'Web-Agenturen',
'read', 'edit.php?post_type=webagentur');
function webagentur() {
register_post_type('webagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/web-agentur', 'with_front' => false ), /* you can specify its url slug */
