<?php
add_submenu_page( 'agenturfinder', 'Content Agenturen', 'Content Agenturen',
'read', 'edit.php?post_type=contentagentur');
function contentagentur() {
register_post_type('contentagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/content-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'contentagentur');
