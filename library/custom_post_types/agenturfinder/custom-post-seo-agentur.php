<?php
add_submenu_page( 'agenturfinder', 'SEO Agenturen', 'SEO Agenturen',
'read', 'edit.php?post_type=seoagentur');
function seoagentur() {
register_post_type('seoagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/seo-agentur', 'with_front' => false ), /* you can specify its url slug */
