<?php
add_submenu_page( 'agenturfinder', 'Webdesign-Agenturen', 'Webdesign-Agenturen',
'read', 'edit.php?post_type=webdesignagentur');
function webdesignagentur() {
register_post_type('webdesignagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/webdesign-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'webdesignagentur');
