<?php
add_submenu_page( 'agenturfinder', 'Inbound Marketing Agenturen', 'Inbound Marketing Agenturen',
'read', 'edit.php?post_type=inboundagentur');
function inboundagentur() {
register_post_type('inboundagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/inbound-marketing-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'inboundagentur');
