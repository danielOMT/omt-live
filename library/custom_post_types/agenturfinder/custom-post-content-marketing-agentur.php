<?php
add_submenu_page( 'agenturfinder', 'Content Marketing Agenturen', 'Content Marketing Agenturen',
'read', 'edit.php?post_type=cmagentur');
function cmagentur() {
register_post_type('cmagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/content-marketing-agentur', 'with_front' => false ), /* you can specify its url slug */
