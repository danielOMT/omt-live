<?php
add_submenu_page( 'agenturfinder', 'Online Marketing Agenturen', 'Online Marketing Agenturen',
'read', 'edit.php?post_type=omagentur');
function omagentur() {
register_post_type('omagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/online-marketing-agentur', 'with_front' => false ), /* you can specify its url slug */
