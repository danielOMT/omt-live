<?php
add_submenu_page( 'agenturfinder', 'Linkbuilding-Agenturen', 'Linkbuilding-Agenturen',
'read', 'edit.php?post_type=linkbuildingagentur');
function linkbuildingagentur() {
register_post_type('linkbuildingagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/linkbuilding-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'linkbuildingagentur');
