<?php
add_submenu_page( 'agenturfinder', 'SEA Agenturen', 'SEA Agenturen',
'read', 'edit.php?post_type=seaagentur');
function seaagentur() {
register_post_type('seaagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/sea-agentur', 'with_front' => false ), /* you can specify its url slug */
