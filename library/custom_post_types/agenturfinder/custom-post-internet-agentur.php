<?php
add_submenu_page( 'agenturfinder', 'Internetagenturen', 'Internetagenturen',
'read', 'edit.php?post_type=internetagentur');
function internetagentur() {
register_post_type('internetagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/internet-agentur', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'internetagentur');
