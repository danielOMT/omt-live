<?php
add_submenu_page( 'agenturfinder', 'Wordpress-Agenturen', 'Wordpress-Agenturen',
'read', 'edit.php?post_type=wpagentur');
function wpagentur() {
register_post_type('wpagentur', array(
'labels' => array(
...
'rewrite'	=> array( 'slug' => 'agentur-finden/wordpress-agentur', 'with_front' => false ), /* you can specify its url slug */
