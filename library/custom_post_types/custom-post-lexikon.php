<?php
function lexikon() {
    register_post_type('lexikon', array(
        'labels' => array(
            'name' => __('Lexikon', 'bonestheme'), /* This is the Title of the Group */
        ...
        'description' => __('Alle Artikel zur Themenwelt Lexikon', 'bonestheme'), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite'	=> array( 'slug' => 'lexikon', 'with_front' => false ), /* you can specify its url slug */
