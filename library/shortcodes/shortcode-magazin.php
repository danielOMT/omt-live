...
function magazin_teaser( $atts, $content = null ) {
    ...
    <img class="webinar-image teaser-img"
        ...
        <div class="webinar-teaser-text">
            ...
            <a target="_blank" href="' . $shortcode_link . '" title="' . $shortcode_titel . '" class="button button-blue" style="width:350px;">' . $shortcode_button_text . '</a>
            <a target="_blank" href="' . $shortcode_button_2_link . '" title="' . $shortcode_titel . '" class="button button-red" style="width:350px;margin-top:10px!important;">' . $shortcode_button_2_text . '</a>
        </div>
    </div>';
    } else {
        return '<div class="webinar-teaser card clearfix">
