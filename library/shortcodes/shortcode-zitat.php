...
function omt_zitat_shortcode( $atts ) {
    ...
    <div class="titlebox shortcode-zitat" style="background: #f9f9f9; color: #333333; border: 1px solid #013F6F;">
        ...
        <p class="citation-author"><?php if (strlen($atts['link'])>0) { ?><a target="_blank" href="<?php print $atts['link'];?>"><?php } ?><?php print $atts['author'];?><?php if (strlen($atts['link'])>0) { print "</a>"; }?></p>
        </div>
    </div>
