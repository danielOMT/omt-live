                            ...
                            <div class="tab highlight-last tab-buttons termine-sticky">
                                <div class="seminar-header-sticky">
                                    ...
                                    <div class="sticky-buttons">
                                        ...
                                        <a class="tablinks tablinks-termine stayvisible" href="#selected" onclick="openTab(event, 'termine')">Termine</a>
                                                            ...
                                                            <div class="omt-seminar seminartermin teaser teaser-small">
                                                                ...
                                                                <div class="webinar-meta">
                                                                    ...
                                                                    <b>
                                                                        ...
                                                                        <span style="display:block;width:100%;">in&nbsp;<a href="<?php print get_the_permalink($seminar['location']); ?>">
                                                                            <?php } ?>
                                                                    ...
                                                                    <?php } ?></b>
                                                                    <span style="display:block;width:100%;"><?php if ($seminar['regularprice'] != $seminar['price']) { ?><span class="discountbadge">10%</span><?php } ?>
