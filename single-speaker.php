...
use OMT\Model\Ebook;
use OMT\Model\OmtDownload;
use OMT\Model\OmtStudentWork;
use OMT\Model\Tool;
...
$ebookModel = Ebook::init();
$toolModel = Tool::init();

$titel = get_field('titel');;
$profilbild = get_field('profilbild');
$firma = get_field('firma');
$speaker_galerie = get_field('speaker_galerie');
...
$expertEbooks = $ebookModel->withExtraData($ebookModel->items(['expert' => $speaker_id]));
$expertReportTools = $toolModel->authorTools($speaker_id);
$expertApplicationTipsTools = $toolModel->authorTools($speaker_id, 'applicationTips');
$expertDownloads = OmtDownload::init()->authorDownloads($speaker_id);
$expertStudentWorks = OmtStudentWork::init()->authorStudentWorks($speaker_id);
...
?>
    ...
    <div class="omt-row hero-header header-flat" style="background: url('<?php print $hero_background['url'];?>') no-repeat 50% 0;">
        <div class="wrap">
            <h1 class=""><?php print $speaker_name;?> - OMT-Experte</h1>
        </div>
    </div>
    <div id="main" class="clearfix omt-speaker speaker-<?php print str_replace(' ', '-', $speaker_name);?> speaker-id-<?php print $speaker_id;?>" role="main">
        <div id="inner-content" class="wrap clearfix speaker-information <?php print str_replace(' ', '-', $speaker_name);?>"> <?php ///***SPEAKER BESCHREIBUNG***///?>
            <div class="omt-intro speaker-info">
            ...
            <?php ///////////////////////////eBooks GO HERE//////////////////////////?>
            <?php if (count($expertEbooks)) : ?>
                <div class="omt-row speaker-downloads">
                    <div class="color-area-grau x-w-full">
                        <div class="color-area-inner"></div>
                        <h4>eBooks von <?php print get_the_title();?></h4>

                        <div class="teaser-modul speaker-webinare">
                            <?php echo EbookView::loadTemplate('mixed-items', [
                                'ebooks' => $expertEbooks,
                                'showExpert' => false
                            ]) ?>
                        </div>
            ...
            <?php /////////////////////////// Tools Testbericht GO HERE//////////////////////////?>
            <?php if (count($expertReportTools)) : ?>
                <div class="omt-row">
                    <h4>Testberichte von <?php echo get_the_title();?></h4>

                    <?php echo AuthorView::loadTemplate('tools', [
                        'tools' => $expertReportTools,
                        'urlAnchor' => '#testbericht'
                    ]) ?>
                </div>
            <?php endif ?>

            <?php /////////////////////////// Tools Anwendungstipps GO HERE//////////////////////////?>
            <?php if (count($expertApplicationTipsTools)) : ?>
                <div class="omt-row">
                    <h4>Anwendungstipps von <?php echo get_the_title();?></h4>

                    <?php echo AuthorView::loadTemplate('tools', [
                        'tools' => $expertApplicationTipsTools,
                        'urlAnchor' => '#anwendungstipps'
                    ]) ?>
                </div>
            <?php endif ?>

            <?php /////////////////////////// Studentenarbeiten GO HERE//////////////////////////?>
            <?php if (count($expertStudentWorks)) : ?>
                <div class="omt-row speaker-downloads">
                    <div class="color-area-grau x-w-full">
                        <div class="color-area-inner"></div>
                        <h4>Studentenarbeiten von <?php echo get_the_title();?></h4>

                        <div class="teaser-modul">
                            <?php echo AuthorView::loadTemplate('downloads', ['items' => $expertStudentWorks]) ?>
                        </div>
                    </div>
                </div>
            <?php endif ?>

            <?php /////////////////////////// Leadmagneten GO HERE//////////////////////////?>
            <?php if (count($expertDownloads)) : ?>
                <div class="omt-row speaker-downloads">
                    <div class="color-area-grau x-w-full">
                        <div class="color-area-inner"></div>
                        <h4>Leadmagneten von <?php echo get_the_title();?></h4>

                        <div class="teaser-modul">
                            <?php echo AuthorView::loadTemplate('downloads', ['items' => $expertDownloads]) ?>
                        </div>
                    </div>
                </div>
            <?php endif ?>
                        ...
                        if ($vortrag_speaker_ID == $speaker_id ) {
                            ...
                            <div class="testimonial card clearfix expertenstimme">
                                ...
                                <div class="testimonial-text">
                                    ...
                                    <a class="button no-clear" target="<?php print $target;?>" href="<?php print trim($vortrag_link) ?>">Zum Vortrag</a>
                                </div>
                            </div>
                        <?php }
